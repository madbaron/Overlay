...
namespace overlay
{
  ...
  void OverlayTiming::modifyEvent(EVENT::LCEvent *evt)
  {
    ...
    {
      streamlog_out(MESSAGE) << "Using background file: "
                             << " [ " << m_currentFileIndex << " ] "
  ...
  void OverlayTiming::define_time_windows(const std::string &Collection_name)
  {
    ...
    if (Collection_name == "BeamCalCollection")
    {
      this_stop = _BeamCal_int;
      TPC_hits = false;
    }
    else if (Collection_name == "LumiCalCollection")
    {
      this_stop = _LumiCal_int;
      TPC_hits = false;
    }

    // ILD
    // calo
    else if (Collection_name == "EcalBarrelCollection")
    {
      this_stop = _EcalBarrel_int;
      TPC_hits = false;
    }
    else if (Collection_name == "EcalBarrelPreShowerCollection")
    {
      this_stop = _EcalBarrelPreShower_int;
      TPC_hits = false;
    }
    else if (Collection_name == "EcalEndcapCollection")
    {
      this_stop = _EcalEndcap_int;
      TPC_hits = false;
    }
    else if (Collection_name == "EcalEndcapPreShowerCollection")
    {
      this_stop = _EcalEndcapPreShower_int;
      TPC_hits = false;
    }
    else if (Collection_name == "EcalEndcapRingCollection")
    {
      this_stop = _EcalEndcapRing_int;
      TPC_hits = false;
    }
    else if (Collection_name == "EcalEndcapRingPreShowerCollection")
    {
      this_stop = _EcalEndcapRingPreShower_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HcalBarrelRegCollection")
    {
      this_stop = _HcalBarrelReg_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HcalEndCapRingsCollection")
    {
      this_stop = _HcalEndCapRings_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HcalEndCapsCollection")
    {
      this_stop = _HcalEndCaps_int;
      TPC_hits = false;
    }
    else if (Collection_name == "LHcalCollection")
    {
      this_stop = _LHcal_int;
      TPC_hits = false;
    }
    // muon system
    else if (Collection_name == "MuonBarrelCollection")
    {
      this_stop = _MuonBarrel_int;
      TPC_hits = false;
    }
    else if (Collection_name == "MuonEndCapCollection")
    {
      this_stop = _MuonEndCap_int;
      TPC_hits = false;
    }
    // tracker
    else if (Collection_name == "ETDCollection")
    {
      this_stop = _ETD_int;
      TPC_hits = false;
    }
    else if (Collection_name == "FTDCollection")
    {
      this_stop = _FTD_int;
      TPC_hits = false;
    }
    else if (Collection_name == "SETCollection")
    {
      this_stop = _SET_int;
      TPC_hits = false;
    }
    else if (Collection_name == "SITCollection")
    {
      this_stop = _SIT_int;
      TPC_hits = false;
    }
    else if (Collection_name == "VXDCollection")
    {
      this_stop = _VXD_int;
      TPC_hits = false;
    }
    else if (Collection_name == "TPCCollection")
    {
      this_start = -_TPC_int / 2;
      this_stop = _TPC_int / 2;
      TPC_hits = true;
    }
    else if (Collection_name == "TPCSpacePointCollection")
    {
      this_start = -_TPCSpacePoint_int / 2;
      this_stop = _TPCSpacePoint_int / 2;
      TPC_hits = true;
    }
    ...
    else if (Collection_name == "ECalPlugCollection")
    {
      this_stop = _EcalPlug_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HCalBarrelCollection")
    {
      this_stop = _HcalBarrelReg_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HCalEndcapCollection")
    {
      this_stop = _HcalEndCaps_int;
      TPC_hits = false;
    }
    else if (Collection_name == "HCalRingCollection")
    {
      this_stop = _HcalEndCapRings_int;
      TPC_hits = false;
    }
    // muon system
    else if (Collection_name == "YokeBarrelCollection")
    {
      this_stop = _MuonBarrel_int;
      TPC_hits = false;
    }
    else if (Collection_name == "YokeEndcapCollection")
    {
      this_stop = _MuonEndCap_int;
      TPC_hits = false;
    }
    // tracker
    else if (Collection_name == "VertexBarrelCollection")
    {
      this_stop = _VXDB_int;
      TPC_hits = false;
    }
    else if (Collection_name == "VertexEndcapCollection")
    {
      this_stop = _VXDE_int;
      TPC_hits = false;
    }
    else if (Collection_name == "InnerTrackerBarrelCollection")
    {
      this_stop = _ITB_int;
      TPC_hits = false;
    }
    else if (Collection_name == "InnerTrackerEndcapCollection")
    {
      this_stop = _ITE_int;
      TPC_hits = false;
    }
    else if (Collection_name == "OuterTrackerBarrelCollection")
    {
      this_stop = _OTB_int;
      TPC_hits = false;
    }
    else if (Collection_name == "OuterTrackerEndcapCollection")
    {
      this_stop = _OTE_int;
      TPC_hits = false;
    }
